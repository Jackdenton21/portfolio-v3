...
const WorkExperiencePage = () => {
  ...
  return (
    <div className="min-h-screen text-slate-700">
      ...
      >
        <section className="rounded-lg shadow-lg p-6 mb-8 flex items-center font-medium border border-slate-700">
        ...
        <section className="rounded-lg shadow-lg p-6 mb-8 flex border border-slate-700">
          ...
          <div className="flex-1 ml-4">
            ...
            >
              ...
              <motion.li
                ...
                style={{ marginTop: '1rem' }}
              >
                Integrated the MapBox GL JS API to create a visually compelling representation of the data.
              </motion.li>
              <motion.li
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                style={{ marginTop: '1rem' }}
              >
                Utilized GitHub for effective version control and project management, ensuring timely completion of tasks and seamless collaboration with team members.
              </motion.li>
            </ul>
          </div>
        </section>
            ...
            <div className="flex-1 ml-4">
              ...
              >
                <motion.li
                  ...
                  transition={{ duration: 0.6, delay: 0.6 }}
                >
                  Collaborated with multinational brands on a variety of marketing campaigns and initiatives.
                </motion.li>
                <motion.li
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
