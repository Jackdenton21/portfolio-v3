    ...
    <div className="py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-md rounded-md p-6">
          ...
          <p className="text-gray-700 mb-4">I study Computer Science at McGill University. Some relevant courses I have taken include Algorithms and Data Structures, Software Design Patterns, Computer Systems, Functional Programming, Concurrent Systems, Information Management, and High Tech Venture Creation.</p>
